...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        T = function (t) {
          ...
          for (e = 0; e < O.length; e++)
            if ((n = O[e] + i) in z.style) return { dom: n, css: S[e] + t };
        },
        C = (e.support = {
      ...
      if (C.transition) {
        var M = C.timing.dom;
        if (((z.style[M] = f["ease-in-back"][0]), !z.style[M]))
        ...
        B = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (q(n), e = I(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      var X = t.style,
        Y = t.css,
        G = { transform: C.transform && C.transform.css },
        K = {
          color: [N, g],
      ...
      (t.exports = function (t) {
        ...
        function x(e, i) {
          var r = d.substr(1) + "-" + e,
            ...
            a = t.data(i, d);
          if (
            (a || (a = t.data(i, d, { el: o, config: {} })),
            (a.current = null),
            (a.tabIdentifier = r + "-" + f),
            (a.paneIdentifier = r + "-" + h),
        ...
        function k(e, n) {
          ...
          if (s !== e.current) {
            ...
            e.panes.each(function (e, n) {
              var i = t(n);
              n.getAttribute(f) === s ? l.push(n) : i.hasClass(v) && h.push(n);
            });
            var d = t(l),
              b = t(h);
            if (n.immediate || r.immediate)
              return (
                d.addClass(v).each(m.intro),
                b.removeClass(v),
                void (w || i.redraw.up())
              );
        ...
        return (
          (o.ready = o.design = o.preview = b),
          (o.redraw = function () {
            (w = !0), b(), (w = !1);
          }),
          (o.destroy = function () {
            (e = s.find(d)).length && (e.each(y), g());
          }),
          o
        );
      })
